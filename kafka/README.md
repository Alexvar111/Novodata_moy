...
1. Запустить генерацию событий в Kafka: python producer_kafka_pg.py


2. Чтение в PostgreSQL: python consumer_kafka_pg.py
...
4. Миграция PostgreSQL → Kafka c флагом: python producer_pg_kafka.py
...
6. Загрузка в ClickHouse: python consumer_kafka_clickhouse.py
